...
echo -e "#MTU\trewriting\ttunneling" > $plotdata_file
...
do
	...
	sudo ifconfig dcnet-srv100 mtu $m
	sudo ifconfig em2 mtu $m

	# Start the iperf3 clients
	ssh -f nebula111 "iperf3 -c dc98::d4ae:52c8:c361 -t 25 -Z -A 0 > /dev/null"
	...
	ssh -f nebula111 "iperf3 -c dc91::9191:9100:4 -t 25 -Z -A 0 > /dev/null"
