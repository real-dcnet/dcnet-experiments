...
# Set MTU of all interfaces to 9000
./set_mtu_all.sh
...
ssh nebula103 "sudo tc qdisc del dev rename71 root handle 0:; sudo tc qdisc add dev rename71 root handle 0: pfifo limit 500"
ssh nebula103 "sudo tc qdisc del dev rename72 root handle 0:; sudo tc qdisc add dev rename72 root handle 0: pfifo limit 1000"
